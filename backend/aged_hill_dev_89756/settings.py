"""
Django settings for aged_hill_dev_89756 project.
...
ROOT_URLCONF = 'aged_hill_dev_89756.urls'
...
WSGI_APPLICATION = 'aged_hill_dev_89756.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_hill_dev_89756 API",
    "DESCRIPTION": "API documentation for aged_hill_dev_89756 App",
    "VERSION": "v1",
}
